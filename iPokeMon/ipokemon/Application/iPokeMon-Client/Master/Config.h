...
//#define KY_TAKE_LAUNCH_SCREENSHOT 1               // DEV: Take screenshot for launch image (OFF)
...
//#define NW_REMOTE_CONFIG_ON 1                      // ENORM: Config remotely (OFF)
...
extern NSString * nServerAPIEdge;
#endif
