...
didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
  ...
  [[UIApplication sharedApplication] setStatusBarStyle:UIStatusBarStyleLightContent];
    ...
    // Replace above 2 lines due to "registerForRemoteNotificationTypes: is not supported in iOS 8.0 and later."
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
                                                          ...
                                                          error:&error])
  {
     ...
     * The schema for the persistent store is incompatible with current managed object model.
     ...
     If the persistent store is not accessible, there is typically something wrong with
       the file path. Often, a file URL is pointing into the application's resources
       directory instead of a writeable directory.
