...
@interface MapViewController () {
 @private
  ...
  AnnotationType annotationType_; // current annotation type
...
- (void)viewDidLoad
{
  ...
  // basic settings
  //zoomLevel_                     = 12.f;
    // ENORM: adjust default zoom level
  zoomLevel_                     = 1.f;
  annotationType_                = kAnnotationTypeNone;
