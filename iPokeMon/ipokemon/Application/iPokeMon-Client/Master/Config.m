...
/*
 * Server if not using local host
 */
// e.g. http://123.123.123.123:8080
//ENORM: this is the cloud server
NSString * const kServerAPIRoot = @"http://54.171.79.202:8000/";
//ENORM: on localhost edge server is set to port 8080
NSString * nServerAPIEdge;
...
NSString * const kOAuthClientIdentifier = @"iPokeMonClientIdentifier";
//
// Google
// Client ID for Google's Authentication
//   e.g. "123456789012.apps.googleusercontent.com"
NSString * const kOAuthGoogleClientID = @"658685239371-gst6u1d0o8irdjotsb9lt6j2smf8kf6v.apps.googleusercontent.com";
//
...
// Any string value is okay, but alpha is better
//   e.g. "PMOAuth2_Google"
NSString * const kOAuthGoogleKeychainItemName = @"PMOAuth2_Google";
//
